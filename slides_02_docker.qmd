...
- My DockerHub profile: [ztshi](https://hub.docker.com/repositories/ztshi)
...
```bash
docker login
docker tag myimage:0.1 yourname/myimage:0.1
docker push yourname/myimage:0.1
docker pull yourname/myimage:0.1
```
:::
...
- `latest` is just a tag, not always the newest
- Prefer explicit versions for reproducibility
- Example: `ztshi/econ5821:v0.1`
